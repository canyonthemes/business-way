...
if ( ! function_exists( 'business_way_about_setup' ) ) :
	...
	function business_way_about_setup() {
		...
		$config = array(
			...
			// Welcome content.
			'welcome_content' => sprintf( esc_html__( '%1$s is now installed and ready to use. Thank you for choosing Business Way Pro for your Website. Please follow theme documentation properly to know how to use Business Way Pro.', 'business-way' ), 'Business Way Pro' ),
