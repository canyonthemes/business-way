...
* Boostnav https://github.com/adamnurdin01/bootsnav/blob/master/LICENSE The MIT License (MIT) Copyright (c) 2016 adamnurdin01

* Jquery circle progress https://github.com/kottenator/jquery-circle-progress/blob/master/LICENSE The MIT License (MIT) Copyright (c) 2014 Rostyslav Bryzgunov

* Gmap http://hpneo.github.com/gmaps/ Copyright 2016, Gustavo Leon Released under the MIT License.

* HTML5 Shiv https://github.com/aFarkas/html5shiv/blob/master/MIT%20and%20GPL2%20licenses.md Copyright (c) 2014 Alexander Farkas (aFarkas), MIT License

* Jquery Circleful https://github.com/pguso/jquery-plugin-circliful/blob/master/LICENSE The MIT License (MIT) Copyright (c) 2014 Patric Gutersohn

* Counterup https://github.com/bfintal/Counter-Up/blob/master/LICENSE, GNU GENERAL PUBLIC LICENSE

* jQuery One Page Nav Plugin http://github.com/davist11/jQuery-One-Page-Nav Copyright (c) 2010 Trevor Davis (http://trevordavis.net) Dual licensed under the MIT and GPL licenses.

* Meta Slider https://github.com/wp-plugins/master-slider/blob/master/LICENSE.txt, GNU GENERAL PUBLIC LICENSE
...
* Owl Carousel Licensed under MIT (https://github.com/OwlCarousel2/OwlCarousel2/blob/master/LICENSE)

* Parallax JS Dual licensed under the MIT and GPL license, http://www.opensource.org/licenses/mit-license.php and http://www.gnu.org/licenses/gpl.html

* Respond JS - https://github.com/scottjehl/Respond/blob/master/LICENSE-MIT, Copyright 2013 Scott Jehl
...
https://pixabay.com/en/laptop-code-programming-computer-2557468/
